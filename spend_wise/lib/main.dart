...
Future<void> _insertInitialData() async {
  ...
  final Map<String, Category> categoryMap = {for (var c in categories) c.name: c};
...
class SpendWiseApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Use Builder to provide a valid context for Navigator.of(context)
      home: Builder(
        builder: (context) {
          // Now we pass the correct context to DashboardScreen's onNavigate callback
          return DashboardScreen(
            ...
            onNavigate: (index) async {
              if (index == 1) { // Transactions List
                await Navigator.of(context).push(MaterialPageRoute(builder: (c) => const TransactionsScreen()));
              } 
              // else if (index == 3) { // Categories
            ...
            // FAB (Add Transaction) is now removed, callback is empty
